...
app.get('/mithuntechnologies', function(request, response) {
    ...
    response.write("<h2><center>Welcome to  MBK InfoTech Solutions. Please Contact +91-9844424739 for more information or send an email to mbkinfotechsolutions@gmail.com <center></h2>" );
    response.end();
...
app.get("/html", function(req,res){
    ...
    app.get("/jsonData", function(req,res){
        ...
        //res.json({'name': 'KIRAN KUMAR'});
        res.send({
		'name': 'MBK InfoTech Solutions',
		'technology': 'DevOps',
		'contact' : '9844424739',
		'email': 'mbkinfotechsolutions@gmail.com'
	            });
...
app.get('/redirect', function(req, res) {
    //Send status 300
        res.redirect('http://mbkinfo.com');
    });
    
 
    app.listen(app.get('port'), function() {
        console.log("Node JS app is running at http://localhost:" + app.get('port') +"/mbkinfotechsolutions");
      })
